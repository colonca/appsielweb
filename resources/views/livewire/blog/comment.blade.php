<form class="w-full md:w-8/12 mx-auto" wire:submit.prevent="postComment">
    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-2">
        <div class="relative md:mr-2">
            <input type="text" class="w-full bg-gray-800 text-sm rounded w-64 px-4 pl-8 py-1 focus:outline-none" placeholder="Nombre *" wire:model.lazy="name">
        ...
        <div class="relative mt-1 md:mt-0">
            <input type="text" class="w-full bg-gray-800 text-sm rounded w-64 px-4 pl-8 py-1 focus:outline-none" placeholder="Email *" wire:model.lazy="email">
            <div class="absolute top-0">
    ...
    <button type="submit" class="mt-2 py-1 px-8 bg-gray-800 rounded font-semibold focus:outline-none focus:shadow-outline">Publicar comentario</button>
</form>
