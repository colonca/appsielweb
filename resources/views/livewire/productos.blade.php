    ...
    <div class="wraper">
        ...
        <div class="productos__grid activo-servicio" id="gestion-empresarial">
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/compras.png" alt="Compras">
                <h3 class="title">Compras</h3>
                <p class="descricion">Conozca sus costos y proyecte su margen de utilidad.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/inventarios.png" alt="Inventarios">
                <h3 class="title">Inventarios</h3>
                <p class="descricion">Controle la trazabilidad de sus productos de principio a fin.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/ventas.png" alt="Ventas">
                <h3 class="title">Ventas</h3>
                <p class="descricion">Administre su fuerza de ventas con eficacia.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/tesoreria.png" alt="Tesorería">
                <h3 class="title">Tesorería</h3>
                <p class="descricion">Control en tiempo real del flujo de efectivo.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/contabilidad.png" alt="Contabilidad">
                <h3 class="title">Contabilidad</h3>
                <p class="descricion">Conozca su situación financiera en todo momento.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/nomina.png" alt="Nómina">
        ...
        <div class="productos__grid" id="gestion-educativa">
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/matriculas.png" alt="Matrículas">
                <h3 class="title">Matrículas</h3>
                <p class="descricion">Registro y control académico y disciplinario</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/calificaciones.png" alt="Calificaciones">
            ...
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/academico_docente.png" alt="Académico Docente">
            ...
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/academico_estudiante.png" alt="Académico Estudiante">
        ...
        <div class="productos__grid" id="gestion-salud">
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/historias_clinicas.png" alt="Consultorio médico">
        ...
        <div class="productos__grid" id="desarrollo-web">
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/gestion_documental.png" alt="Gestor de contenidos">
            ...
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/pagina_web.png" alt="Diseño web">
                <h3 class="title">Diseño web</h3>
                <p class="descricion">Creación de sitios web personalizados y dinámicos.</p>
            </div>
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/compras.png" alt="Tienda Online">
        ...
        <div class="productos__grid" id="consultoria-empresarial">
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/contabilidad.png" alt="Branding y diseño de estrategia corporativa">
            ...
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/tesoreria.png" alt="Análisis financiero">
            ...
            <div class="productos__item">
                <img loading="lazy" class="mx-auto w-1/4 h-2/12 md:w-2/4 md:h-3/12" src="https://appsiel.com.co/el_software/assets/img/ventas_pos.png" alt="Análisis comercial">
